...
CREATE TABLE XXL_JOB_QRTZ_JOB_DETAILS
  (
    ...
    IS_DURABLE VARCHAR(255) NOT NULL,
    IS_NONCONCURRENT VARCHAR(255) NOT NULL,
    IS_UPDATE_DATA VARCHAR(255) NOT NULL,
    REQUESTS_RECOVERY VARCHAR(255) NOT NULL,
    JOB_DATA bytea NULL,
...
CREATE TABLE XXL_JOB_QRTZ_SIMPROP_TRIGGERS
  (
    ...
    BOOL_PROP_1 VARCHAR(255) NULL,
    BOOL_PROP_2 VARCHAR(255) NULL,
    PRIMARY KEY (SCHED_NAME,TRIGGER_NAME,TRIGGER_GROUP),
    FOREIGN KEY (SCHED_NAME,TRIGGER_NAME,TRIGGER_GROUP)
    REFERENCES XXL_JOB_QRTZ_TRIGGERS(SCHED_NAME,TRIGGER_NAME,TRIGGER_GROUP)
);
...
CREATE TABLE XXL_JOB_QRTZ_FIRED_TRIGGERS
  (
    ...
    IS_NONCONCURRENT VARCHAR(255) NULL,
    REQUESTS_RECOVERY VARCHAR(255) NULL,
